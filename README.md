...
####Shell 2:
    ...
    tar xzf kagura-assembly-1.0.tar.gz
    cd kagura-assembly-1.0/bin
    ./karaf debug
...
2. Start the assembly project, then shut it down. This creates the com.base2.kagura.services.camel.cfg file in the kagura-assmebly-1.0/etc/
